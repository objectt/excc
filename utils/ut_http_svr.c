...
int send_http_response(nw_ses *ses, http_response_t *response)
{
    ...
    http_response_set_header(response, "Access-Control-Allow-Headers", "Authorization");
    http_response_set_header(response, "Access-Control-Allow-Method", "POST, OPTIONS");
